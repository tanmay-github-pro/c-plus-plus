// Implementing a Queue(Linear) using a 1D array ***remember to add brackets when passing boolean function in if condition
// When initialization of front and rear of queue is "f = 0 and r = -1"
...
{
    // initializing front and rear variables
    f = 0; r = -1;
}
